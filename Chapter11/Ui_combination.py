...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_start_combination.setText(_translate("MainWindow", "開始"))
        ...
        self.checkBox_combination_fund.setText(_translate("MainWindow", "組合基金"))
        self.checkBox_relative_fund.setText(_translate("MainWindow", "相對價值"))
        self.checkBox_others.setText(_translate("MainWindow", "其他策略"))
        self.tabWidget_PGMS.setTabText(self.tabWidget_PGMS.indexOf(self.tab_Combination), _translate("MainWindow", "產品組合管理"))
